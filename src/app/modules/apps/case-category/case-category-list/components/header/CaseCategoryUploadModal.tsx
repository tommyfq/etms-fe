...
const CaseCategoryUploadModal = ({show, handleClose}: Props) => {
    ...
    const handleAlert = (response:{is_ok:boolean, message:string, data:any[]}) => {
      ...
      const handleDownload = () => {
        ...
        const fileUrl = `${import.meta.env.VITE_ETMS_TEMPLATES_URL}/Template_Upload_Case_Category.xlsx`; // No need for process.env.PUBLIC_URL in Vite
    
        // Create a temporary anchor tag to download the file
        const link = document.createElement('a');
        link.href = fileUrl;
        link.setAttribute('download', 'Template_Upload_Case_Category.xlsx'); // Set the filename for download
  ...
  export {CaseCategoryUploadModal}