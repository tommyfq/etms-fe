...
import {useQueryResponseData, useQueryResponseLoading} from '../core/QueryResponseProvder'
...
import {ReportListPagination} from '../components/pagination/ReportListPagination'
        ...
        >
          <thead>
            <tr className='text-start text-muted fw-bolder fs-7 text-uppercase gs-0'>
              {headers.map((column: ColumnInstance<Reporting>) => (
